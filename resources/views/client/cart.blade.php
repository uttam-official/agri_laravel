    ...
    $('#button-coupon').on('click', function() {
        ...
        if (coupon != "") {
                ...
                success: function(data) {
                    if (data.status) {
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Voila',
                            text: `You get $${discount_price} off !`
                        });
                    } else {
                        Swal.fire({
                            icon: 'error',
            ...
            Swal.fire({
                icon: 'error',
                title: 'Oops...',
                text: "Coupon code is just missing!"
            });
        }
    });
                        ...
                        <div class="panel-collapse collapse" id="collapse-coupon">
                            <div class="panel-body">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="input-coupon" placeholder="Enter your coupon here" value="" name="coupon" vk_14527="subscribed">
                                    <span class="input-group-btn">
