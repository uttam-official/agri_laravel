                                ...
                                @if(count($page_data)>0)
                                    @foreach($page_data as $k=>$l)
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <a href="{{url('admin/subcategory/add').'/'.$l->id}}" class="btn btn-sm btn-outline-info" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
                                                <a href="{{url('admin/subcategory/delete').'/'.$l->id}}" class="btn btn-sm btn-outline-danger" data-toggle="tooltip" title="Delete"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
